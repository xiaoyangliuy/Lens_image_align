...
ax1.scatter(x, fwhm_col_list, label="Updated Data points col", color="blue")
ax1.scatter(x, fwhm_row_list, label="Updated Data points row", color="green")
...
ax1.plot(x_fit, y_fit_updated_col, label=f"Polynomial fit col (degree {degree})", color="red")
ax1.plot(x_fit, y_fit_updated_row, label=f"Polynomial fit row (degree {degree})", color="red")
